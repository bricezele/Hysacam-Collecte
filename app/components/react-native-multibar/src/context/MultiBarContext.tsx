...
export const MultiBarContext = React.createContext<MultiBarContextProps>(
    {} as MultiBarContextProps,
);
...
export const MultiBarProvider: React.FC<Props> = ({
    ...
    const [extrasVisible, setExtrasVisible] =
        React.useState(initialExtrasVisible);
